...
public partial class SampleData
 {
     ...
     private async Task CreateCategories()
     {
         ...
         cat = new()
         {
             ...
             CategoryDescription = "Advice on bieng a developer."
         };
         await categoryData.CreateCategory(cat);
         cat = new()
         {
     ...
     private async Task CreateStatuses()
     {
         ...
         {
             StatusName = "Watching",
             StatusDescription = "The suggestions is interesting. We're watching to see how much interest there is in it."
         };
         await statusData.CreateStatus(stat);
         stat = new()
         {
